    ...
    <div class="container px-6 mx-auto grid">
        <form action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="relative">
                    <x-text-input placeholder=" " type="text" id="namaPengajuan" name="namaPengajuan" class="block w-full" value="{{ old('namaPengajuan') }}" required autofocus />
                    <x-input-label for="namaPengajuan" :value="__('Nama Pengaju')" />
                    <x-input-error :messages="$errors->get('namaPengajuan')" class="mt-2" />
                </div>
                <div class="mt-4 relative">
                    <x-text-input placeholder=" " type="date" id="tanggalPengajuan" name="tanggalPengajuan" class="block w-full" value="{{ old('tanggalPengajuan') }}" required autofocus />
