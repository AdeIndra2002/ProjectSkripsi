<x-app-layout>
    ...
    <div class="flex flex-wrap p-4 bg-white rounded-lg shadow-xs ">
        {{-- {{ __('kamu janda pirang merah menyala') }} --}}
        <div class="m-3  max-w-auto w-auto h-3/2 bg-white rounded-lg shadow dark:bg-gray-800 p-1 md:p-6">
