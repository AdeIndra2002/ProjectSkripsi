                    ...
                    <div class="relative bg-white shadow-md dark:bg-gray-700 sm:rounded-lg">
                        <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                            <div class="w-full md:w-1/2">
                                <form action="{{ route('pembelians.index') }}" method="GET" class="max-w-sm pt-1">
                            ...
                            <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                                <button type="button" class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-primary-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                    ...
                                    <a href="{{ route('pembelians.create') }}" type="button"><i class=" "></i> Tambah Data</a>
                                </button>
                                <div class="flex items-center w-full space-x-3 md:w-auto">
                                    ...
                                    <div id="sortDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-600">
                                        ...
                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="sortDropdownButton">
                                            ...
                                            <li>
                                                <a href="{{ route('pembelians.index', ['sort' => 'price_asc']) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-500 dark:hover:text-white">Harga dari Kecil ke Besar</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('pembelians.index', ['sort' => 'price_desc']) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-500 dark:hover:text-white">Harga dari Besar ke Kecil</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('pembelians.index', ['sort' => 'date_asc']) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-500 dark:hover:text-white">Tanggal dari Terlama ke Terbaru</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('pembelians.index', ['sort' => 'date_desc']) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-500 dark:hover:text-white">Tanggal dari Terbaru ke Terlama</a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <table class="whitespace-no-wrap w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead>
                                <tr class=" text-xs font-semibold tracking-wide text-center text-gray-500 uppercase border-b dark:border-gray-700 dark:text-gray-400 dark:bg-gray-900">
                                    ...
                                    <th class=" px-4 py-3">Nama Pembelian</th>
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                ...
                                <tr class=" text-gray-400 text-center">
                                    ...
                                    <td class=" px-4 py-3">{{ $pembelian->pengajuan->namaPengajuan ?? 'Nama tidak tersedia' }}</td>
                                    <td class="px-4 py-3">
                                        {{ $pembelian->tanggal_pembelian ? $pembelian->tanggal_pembelian->format('d-m-Y') : 'Tanggal tidak tersedia' }}
                                    </td>
                                    <td class=" px-4 py-3">Rp. {{ number_format($pembelian->total_harga, 0, ',', '.') }}</td>

                                    <td class="px-4 py-3">
                                        <div class="flex justify-center space-x-1">
                                            <a href="{{ route('pembelians.show', $pembelian->id) }}" class="flex items-center px-2 py-2 text-sm font-medium leading-5 text-gray-800 bg-white-300 rounded-lg dark:text-gray-500 hover:dark:text-green-300 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                                                    <path d="M11.625 16.5a1.875 1.875 0 1 0 0-3.75 1.875 1.875 0 0 0 0 3.75Z" />
                                                    <path fill-rule="evenodd" d="M5.625 1.5H9a3.75 3.75 0 0 1 3.75 3.75v1.875c0 1.036.84 1.875 1.875 1.875H16.5a3.75 3.75 0 0 1 3.75 3.75v7.875c0 1.035-.84 1.875-1.875 1.875H5.625a1.875 1.875 0 0 1-1.875-1.875V3.375c0-1.036.84-1.875 1.875-1.875Zm6 16.5c.66 0 1.277-.19 1.797-.518l1.048 1.048a.75.75 0 0 0 1.06-1.06l-1.047-1.048A3.375 3.375 0 1 0 11.625 18Z" clip-rule="evenodd" />
                                                    <path d="M14.25 5.25a5.23 5.23 0 0 0-1.279-3.434 9.768 9.768 0 0 1 6.963 6.963A5.23 5.23 0 0 0 16.5 7.5h-1.875a.375.375 0 0 1-.375-.375V5.25Z" />
                                            ...
                                            <a href="{{ route('pembelians.edit', $pembelian->id) }}" class="flex items-center px-2 py-2 text-sm font-medium leading-5 text-gray-800 bg-white-300 rounded-lg dark:text-gray-500 hover:dark:text-yellow-300 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
                                                <svg class="w-5 h-5 tr" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                                </svg>
                                            </a>
                                            <!-- Modal Trigger -->
                                            <button x-data="" x-on:click.prevent="$dispatch('open-modal', 'confirm-pembelian-deletion-{{ $pembelian->id }}')" class="flex items-center px-2 py-2 text-sm font-medium text-red-700 bg-white-700 rounded-lg dark:text-gray-500 hover:dark:text-red-700 focus:outline-none focus:shadow-outline-gray">
                                                <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                                                </svg>
                                            </button>
                                            <!-- Modal -->
                                            <x-modal name="confirm-pembelian-deletion-{{ $pembelian->id }}" focusable>
                                                <form method="post" action="{{ route('pembelians.destroy', $pembelian->id) }}" class="p-6">
                                                    @csrf
                                                    @method('delete')
