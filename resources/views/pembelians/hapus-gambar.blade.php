    ...
    <div class="container px-6 mx-auto grid">
        ...
        <form action="{{ route('pembelians.update', $pembelian->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('pembelians.edit', $pembelian->id) }}" class="px-4 py-2.5 text-sm font-medium leading-5 text-white bg-purple-600 rounded-lg hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Kembali</a>
            </div>
        </form>
    </div>
</x-app-layout>
